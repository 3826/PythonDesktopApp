...
class DashboardScreen(Tk):
    def __init__(self, gebruikers_id, role):
        ...
        ttk.Label(
            self,
            text=f"Welcome Business Manager {voornaam}!",
            font=("Segoe UI", 14)
    ...
    def open_trainee_popup(self):
        ...
        # Fetch (id, username) tuples of unlinked trainees for business managers
        trainees = UserLinking.get_available_trainees_for_manager("business_manager", self.gebruikers_id)
    ...
    def update_linked_view(self):
        ...
        # Get trainees linked to THIS business manager
        linked_ids = UserLinking.get_linked_trainees(self.gebruikers_id, "business_manager")
